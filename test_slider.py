...
s1 = Slider(ax_theta1, 'Theta1', 0, 120, valinit=theta1_init)

ax_theta2 = plt.axes([0.1, 0.1, 0.3, 0.03])
s2 = Slider(ax_theta2, 'Theta2', -120, 120, valinit=theta2_init)

ax_theta3 = plt.axes([0.1, 0.05, 0.3, 0.03])
s3 = Slider(ax_theta3, 'Theta3', -120, 120, valinit=theta3_init)

ax_theta4 = plt.axes([0.6, 0.15, 0.3, 0.03])
s4 = Slider(ax_theta4, 'Theta4', 60, 180, valinit=theta4_init)

ax_theta5 = plt.axes([0.6, 0.1, 0.3, 0.03])
s5 = Slider(ax_theta5, 'Theta5', -120, 120, valinit=theta5_init)

ax_theta6 = plt.axes([0.6, 0.05, 0.3, 0.03])
s6 = Slider(ax_theta6, 'Theta6', -120, 120, valinit=theta6_init)
